...
<table width='100%'>
    <tr>
        <td align='left' width='100%' colspan='2'>
            🎯  <b>pudl</b> is a JavaScript-based static site generator (SSG) for quick-prototyping for creating awesome little static demos while teaching/presenting. It significantly cuts down your dev-setup time and improves productivity.
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td align='center'>
            <a href='https://MaedahBatool.com/'>
                <img src='https://img.shields.io/badge/→-MAEDAH%30BATOOL-gray.svg?colorB=5734F5&style=flat-square' width='120' />
            </a>
        </td>
    </tr>
</table>
